...
<header class=" bg-[#062345] w-full sticky top-0 z-50">
    <div class="relative flex items-center max-w-[1200px] mx-auto py-[10px] sm:py-[11px] justify-between px-[15px] sm:px-[20px] ">
            <a href="/" class="animated-element !flex items-center gap-[9px] md:gap-[12px] cursor-pointer ">
                <img class="h-[36px]" src='/assets/images/newLightLogo.png' alt="" />
                <div>
                    <h2 class="text-[#fff] text-[18px] md:text-[21px] font-[600] Familjen Grotesk select-none ">Hashed System</h2>
            ...
            <div class="hidden lg:block">
                <div class="flex items-center gap-[28px] lg:gap-[44px] ">
                    <a href="/">
                        <div class=" capitalize text-[13px] lg:text-[14px] text-[#fff] cursor-pointer font-[500] group Arimo ">
                            Home<div class=" {{ Route::currentRouteName() === 'index' ? 'w-full' : '' }} rounded-[30px] bg-[#0D99FF] h-[3px] w-[0px] group-hover:w-full transition-all ">
                            </div>
                        </div>
                    </a><a href="/about-us">
                        <div class=" capitalize text-[13px] lg:text-[14px] text-[#fff] cursor-pointer font-[500] group Arimo ">
                            About Us<div class=" {{ Route::currentRouteName() === 'about-us' ? 'w-full' : '' }} rounded-[30px] bg-[#0D99FF] h-[3px] w-[0px] group-hover:w-full transition-all ">
                            </div>
                        </div>
                    </a>
                        <div class=" capitalize text-[13px] lg:text-[14px] text-[#fff] cursor-pointer font-[500] Arimo group  h-10 flex items-center justify-center">
                        <a href="/services">
                            Services
                            <i class="fa-solid fa-angle-down text-[14px] text-[#fff] group-hover:rotate-180 transition-all "></i>
                            <div class=" {{ Route::currentRouteName() === 'services' ? 'w-full' : '' }} rounded-[30px] bg-[#0D99FF] h-[3px] w-[0px] group-hover:w-full transition-all "></div>
                        </a>
                ...
                <a href="/case-studies">
                    <div class=" capitalize text-[13px] lg:text-[14px] text-[#fff] cursor-pointer font-[500] group Arimo ">
                        portfolio<div class=" {{ Route::currentRouteName() === 'portfolio' ? 'w-full' : '' }} rounded-[30px] bg-[#0D99FF] h-[3px] w-[0px] group-hover:w-full transition-all ">
                        </div>
                    </div>
                </a><a href="/blogs">
                    <div class=" capitalize text-[13px] lg:text-[14px] text-[#fff] cursor-pointer font-[500] group Arimo ">
                        Blogs<div class=" {{ Route::currentRouteName() === 'blogs' ? 'w-full' : '' }} rounded-[30px] bg-[#0D99FF] h-[3px] w-[0px] group-hover:w-full transition-all ">
                        </div>
                    </div>
                </a><a href="/contact">
                    <div class=" capitalize text-[13px] lg:text-[14px] text-[#fff] cursor-pointer font-[500] group Arimo ">
                        Contact Us<div class=" {{ Route::currentRouteName() === 'contact' ? 'w-full' : '' }} rounded-[30px] bg-[#0D99FF] h-[3px] w-[0px] group-hover:w-full transition-all ">
                        </div>
                    </div>
                </a>
                <a href='#contact_form' class="flex scroll-smooth items-center justify-center px-[22px] py-[9px] bg-[#0D99FF] rounded-[7px] text-[14px] lg:text-[15px] text-[#fff] cursor-pointer select-none font-[400] ">
                    Get Quote</a>
            </div>
        </div>
        <div class="block lg:hidden " onclick="hamburger()">
            <span class="flex items-center justify-center px-[6px] cursor-pointer "><svg class="h-[22px] w-[22px] sm:h-[28px] sm:w-[28px] " viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect y="0.927734" width="24" height="2.66667" rx="1.33333" fill="#fff"></rect>
                    <rect y="11.5938" width="24" height="2.66667" rx="1.33333" fill="#fff"></rect>
                    <rect y="22.2617" width="24" height="2.66667" rx="1.33333" fill="#fff"></rect>
                </svg>
            </span>
        </div>
    </div>
    <div class="bg-[#fff] w-[220px] fixed top-0 pb-[22px] h-[100%] transition-all z-50 -right-full hamburger-main ">
        <div class="flex items-center gap-[28px] lg:gap-[44px] flex-col justify-center h-full ">
            <div class=" w-full flex items-center justify-end p-[14px] absolute top-11 right-3 " onclick="crosHambuger()"><i class="fa-solid fa-xmark text-[#0D99FF] text-[32px] cursor-pointer "></i>
            </div>
            <a href="/">
            ...
            <a href="/services">
                <div class=" capitalize text-[13px] lg:text-[14px] text-[#0D0A31] cursor-pointer font-[500] group Arimo ">
                    Services<div class=" {{ Route::currentRouteName() === 'services' ? 'w-full' : '' }} rounded-[30px] bg-[#0D99FF] h-[3px] w-[0px] group-hover:w-full transition-all ">
                    </div>
                </div>
            </a>
            <a href="/portfolio">
            ...
            <a href='#contact_form' class="flex items-center justify-center px-[22px] py-[9px] bg-[#0D99FF] rounded-[7px] text-[14px] lg:text-[15px] text-[#fff] cursor-pointer select-none font-[400] ">
                Get Quote</a>
        </div>
    </div>
</header>
